              ...
              >
                ...
                {subscribed ? (
                  ...
                  <form onSubmit={handleSubscribe} className="space-y-3">
                    ...
                    />
                    <button type="submit" className="w-full px-4 py-3 bg-green-500 text-navy-900 font-semibold text-sm rounded-xl hover:bg-green-600 transition-colors font-montserrat">
                      Subscribe
                    </button>
                  </form>
                )}
